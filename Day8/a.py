        ...
        for start_index in range(len(antena)):
            for end_index in range(start_index + 1, len(antena)):
                first_potential_antinode = [
                    2 * antena[start_index][0] - antena[end_index][0],
                    2 * antena[start_index][1] - antena[end_index][1],
                ]
                second_potential_antinode = [
                    2 * antena[end_index][0] - antena[start_index][0],
                    2 * antena[end_index][1] - antena[start_index][1],
                ]
